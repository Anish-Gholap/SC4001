"""
Script to train an LSTM model for emotion classification.
"""
import torch
...
from models import RNNLSTMClassifier
from training import train_model, test_model, plot_training_history
from utils import set_seed, get_device, save_model_info

def main():
    """Train and evaluate an LSTM model for emotion classification."""
    print("="*80)
    print("TRAINING LSTM MODEL FOR EMOTION CLASSIFICATION")
    print("="*80)
    ...
    plot_training_history(history, title_prefix="LSTM Model: ")
